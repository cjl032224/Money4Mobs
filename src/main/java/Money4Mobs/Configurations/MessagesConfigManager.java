...
public class MessagesConfigManager {
    ...
    public void setup() throws IOException {
        ...
        if(!messagesFile.exists()){
            ...
            // Chinese Traditional
            messagesCfg.set("language.chinese_traditional.mobKillerOnMessage.message","&6已啟用 &aMobKiller。");
            messagesCfg.set("language.chinese_traditional.mobKillerOffMessage.message","&6已停用 &aMobKiller。 ");
            messagesCfg.set("language.chinese_traditional.accessDeniedMessage.message","&c你沒有使用該指令的權限。");
            messagesCfg.set("language.chinese_traditional.eggSpawnRewardTrueMessage.message","&a將生怪蛋生成的生物殺死獲得金錢設定為 &6true &a。");
            messagesCfg.set("language.chinese_traditional.eggSpawnRewardFalseMessage.message","&a將生怪蛋生成的生物殺死獲得金錢設定為 &6false &a。");
            messagesCfg.set("language.chinese_traditional.spawnerSpawnRewardTrueMessage.message","&a將生怪磚生成的生物殺死獲得金錢設定為 &6true &a。");
            messagesCfg.set("language.chinese_traditional.spawnerSpawnRewardFalseMessage.message","&a將生怪磚生成的生物殺死獲得金錢設定為 &6false &a。");
            messagesCfg.set("language.chinese_traditional.tamedWolvesRewardTrueMessage.message","&a將馴服的狼殺死生物獲得金錢設定為 &6true &a。");
            messagesCfg.set("language.chinese_traditional.tamedWolvesRewardFalseMessage.message","&a將馴服的狼殺死生物獲得金錢設定為 &6false &a。");
            ...
            messagesCfg.set("language.chinese_traditional.customDropsNotEnabledMessage.message","&a尚未啟用生物 &6%mobName% &a的自訂義掉落。");
            ...
            messagesCfg.set("language.chinese_traditional.customDropsNotSetMessage.message","&a生物 &6%mobName% &a沒有設定任何自定義掉落。");
            ...
            messagesCfg.set("language.chinese_traditional.defaultDropsTrueMessage.message","&a生物 &6%mobName% &a的預設掉落物調整成 &6true&a 。");
            messagesCfg.set("language.chinese_traditional.defaultDropsFalseMessage.message","&a生物 &6%mobName% &a的預設掉落物調整成 &6false&a 。");
            messagesCfg.set("language.chinese_traditional.customDropsTrueMessage.message","&a生物 &6%mobName% &a的自訂義掉落物調整成 &6true &a。");
            messagesCfg.set("language.chinese_traditional.customDropsFalseMessage.message","&a生物 &6%mobName% &a的自訂義掉落物調整成 &6false &a。");
            messagesCfg.set("language.chinese_traditional.languageChangeSuccessMessage.message","&a已設定 Money4Mobs 的語言為 &6繁體中文。");
            messagesCfg.set("language.chinese_traditional.moneyRewardedMessage.message","&a你獲得了 &6$ %amount%  元 &a，現在總共有 &6$ %balance%  元 &a。");
            messagesCfg.set("language.chinese_traditional.moneySubtractedMessage.message","&a你被拿走 &6$ %amount%  元 &a，現在總共有 &6$ %balance%  元 &a。");
            ...
            // Chinese Simplified
            messagesCfg.set("language.chinese_simplified.mobKillerOnMessage.message","&6已启用 &aMobKiller。");
            messagesCfg.set("language.chinese_simplified.mobKillerOffMessage.message","&6已停用 &aMobKiller。");
            messagesCfg.set("language.chinese_simplified.accessDeniedMessage.message","&c你没有使用该指令的权限。");
            messagesCfg.set("language.chinese_simplified.eggSpawnRewardTrueMessage.message","&a将生怪蛋生成的生物杀死获得金钱设定为 &6true &a。");
            messagesCfg.set("language.chinese_simplified.eggSpawnRewardFalseMessage.message","&a将生怪蛋生成的生物杀死获得金钱设定为 &6false &a。");
            messagesCfg.set("language.chinese_simplified.spawnerSpawnRewardTrueMessage.message","&a将生怪砖生成的生物杀死获得金钱设定为 &6true &a。");
            messagesCfg.set("language.chinese_simplified.spawnerSpawnRewardFalseMessage.message","&a将生怪砖生成的生物杀死获得金钱设定为 &6false &a。");
            messagesCfg.set("language.chinese_simplified.tamedWolvesRewardTrueMessage.message","&a将驯服的狼杀死生物获得金钱设定为 &6true &a。");
            messagesCfg.set("language.chinese_simplified.tamedWolvesRewardFalseMessage.message","&a将驯服的狼杀死生物获得金钱设定为 &6false &a。");
            ...
            messagesCfg.set("language.chinese_simplified.addCustomDropsCommandErrorMessage.message","&c错误 : &7用法说明 -> /mk addCustomDrop [生物名称] [物品名称] [数量] [机率]。");
            messagesCfg.set("language.chinese_simplified.addCustomDropAlreadyPresentErrorMessage.message","&c错误 : &6%itemName% &7已经设定自定义掉落。");
            messagesCfg.set("language.chinese_simplified.addCustomDropSuccessMessage.message","&a新增 &6%chance% % &a的机率让生物 &6%mobName% &a掉落 &6%amount% 个 %itemName% &a。");
            ...
            messagesCfg.set("language.chinese_simplified.customDropsNotEnabledMessage.message","&a尚未启用生物 &6%mobName% &a的自订义掉落。");
            ...
            messagesCfg.set("language.chinese_simplified.mobDropInfoMessage.message","&a生物 &6%mobName% &a有 &6%chance% % &a的机率掉落 &6%amount% 个 %itemName% &a。");
            messagesCfg.set("language.chinese_simplified.customDropsNotSetMessage.message","&a生物 &6%mobName% &a没有设定任何自定义掉落。");
            ...
            messagesCfg.set("language.chinese_simplified.defaultDropsTrueMessage.message","&a生物 &6%mobName% &a的预设掉落物调整成 &6true&a 。");
            messagesCfg.set("language.chinese_simplified.defaultDropsFalseMessage.message","&a生物 &6%mobName% &a的预设掉落物调整成 &6false&a 。");
            messagesCfg.set("language.chinese_simplified.customDropsTrueMessage.message","&a生物 &6%mobName% &a的自订义掉落物调整成 &6true &a。");
            messagesCfg.set("language.chinese_simplified.customDropsFalseMessage.message","a生物 &6%mobName% &a的自订义掉落物调整成 &6false &a。");
            messagesCfg.set("language.chinese_simplified.languageChangeSuccessMessage.message","&a已设定 Money4Mobs 的语言为 &6繁体中文。");
            messagesCfg.set("language.chinese_simplified.moneyRewardedMessage.message","&a你获得了 &6$ %amount%  元 &a，现在总共有 &6$ %balance%  元 &a。");
            messagesCfg.set("language.chinese_simplified.moneySubtractedMessage.message","&a你被拿走 &6$ %amount%  元 &a，现在总共有 &6$ %balance%  元 &a。");
    ...
    public void update155PercentageLostPlayerKillPlayer() throws IOException {
        if (Boolean.FALSE.equals(messagesCfg.isSet("language.english.playerKilledPlayerMessage.message"))) {
            ...
            messagesCfg.set("language.chinese_simplified.playerKilledPlayerMessage.message","&a你被给予 &6$ %amount%  元 &a，现在总共有 &6$ %balance%  元 &a。");
            messagesCfg.set("language.chinese_simplified.playerKilledByPlayerMessage.message","&a你被拿走 &6$ %amount%  元 &a，现在总共有 &6$ %balance%  元 &a。");
            ...
            messagesCfg.set("language.chinese_traditional.playerKilledPlayerMessage.message","&a你被給予 &6$ %amount%  元 &a，現在總共有 &6$ %balance%  元 &a。");
            messagesCfg.set("language.chinese_traditional.playerKilledByPlayerMessage.message","&a你被拿走 &6$ %amount%  元 &a，現在總共有 &6$ %balance%  元 &a。");
    ...
    public static void add165CommandErrorMessages() {
        if (Boolean.FALSE.equals(messagesCfg.isSet("language.english.incompleteCommandErrorMessage.message"))) {
            ...
            messagesCfg.set("language.chinese_simplified" + incompleteMessage, "&c错误 : &7可用的指令 -> /mk [worth、drops、language、 reload、removeCustomDrop、setLowWorth、setHighWorth、toggleCustomDrops、toggleDefaultDrops、toggleKM、toggleMoneyFromSpawnEggs、toggleMoneyFromSpawners、toggleMoneyFromTamedWolves。");
        }
    }
    ...
    public static void add170MobWorldAddRemoveMessages() {
        if (Boolean.FALSE.equals(messagesCfg.isSet("language.english.addWorldSuccessMessage.message"))) {
            ...
            messagesCfg.set("language.chinese_traditional" + addWorldCommandErrorMessage, "&c錯誤 : &7用法說明 -> /mk addWorld [世界名稱]。");
            messagesCfg.set("language.chinese_simplified" + addWorldCommandErrorMessage, "&c错误 : &7用法说明 -> /mk addWorld [世界名称]。");
            ...
            messagesCfg.set("language.chinese_traditional" + removeWorldCommandErrorMessage, "&c錯誤 : &7用法說明 -> /mk removeWorld [世界名稱]。");
            messagesCfg.set("language.chinese_simplified" + removeWorldCommandErrorMessage, "&c错误 : &7用法说明 -> /mk removeWorld [世界名称]。");
            ...
            messagesCfg.set("language.chinese_simplified" + removeWorldFailureMessage, "&c错误 : &7世界不存在或大小写不正确。");
        }
    }
